...
for testing the LibreCudaISP pipeline.
...
def main():
    ...
    # Always emit a JSON sidecar so LibreCudaISP can pick it up automatically.
    ...
    print(f"  ./build/libreisp {output_path} output.png")
